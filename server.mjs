...
function worksheetDifficultyBank(chapter, difficulty) {
  const bank = worksheetQuestionBank(chapter);
  const overrides = {
    "七上：有理数": {
      "中档提高": [
        ["计算：(-4) × (6 - 9) - 18 ÷ 3。", "12 - 6 = 6"],
        ["若 |a - 2| = 5，求 a 可能的值。", "a = 7 或 a = -3"],
        ["把 -3.5，2，0，-1 按从小到大的顺序排列。", "-3.5 < -1 < 0 < 2"],
        ["计算：-2^2 + (-3) × 4。", "-4 - 12 = -16"],
        ["某地上午气温为 -2°C，下午升高 7°C，晚上又下降 4°C，求晚上气温。", "1°C"]
      ],
      "综合挑战": [
        ["计算：-3 × [2 - (-4)] + 24 ÷ (-6)。", "-18 - 4 = -22"],
        ["若 a < 0，b > 0，且 |a| = 6，|b| = 4，求 a + b。", "-6 + 4 = -2"],
        ["数轴上点 A 表示 -3，点 B 表示 5，点 C 是 AB 的中点，求 C 表示的数。", "1"],
        ["规定 a △ b = a - 2b，求 (-3) △ 5。", "-13"],
        ["一袋大米先减少 2.5 kg，又增加 1.8 kg，最后比原来多还是少？多或少多少？", "少 0.7 kg"]
      ]
    },
    "七上：整式的加减": {
      "中档提高": [
        ["化简：3(2x - 1) - 2(x + 4)。", "4x - 11"],
        ["化简：5a - [2a - (a - 3)]。", "4a - 3"],
        ["先化简，再求值：2m - (3m - 4) + 5，其中 m = -1。", " -m + 9，值为 10"],
        ["若 A = 2x + 1，B = x - 3，求 A - 2B。", "7"],
        ["一个长方形长为 3a + 2，宽为 a - 1，求周长。", "8a + 2"]
      ],
      "综合挑战": [
        ["化简：2[x - 3(2x - 1)] + 4x。", "-6x + 6"],
        ["若 2a - b = 5，求 4a - 2b + 3 的值。", "13"],
        ["已知 A = 3x^2 - 2x + 1，B = x^2 + x - 4，求 A - 2B。", "x^2 - 4x + 9"],
        ["一个三角形三边分别为 2a + 1，a + 3，3a - 2，求周长。", "6a + 2"],
        ["化简并求值：3(x - 2y) - 2(2x - y)，其中 x = -2，y = 1。", "-x - 4y，值为 -2"]
      ]
    },
    "七上：一元一次方程": {
      "中档提高": [
        ...
        ["解方程：3(x - 2) = 2x + 5。", "x = 11"],
        ["解方程：(x - 1) / 2 = 3。", "x = 7"],
        ["一个数的一半加 6 等于 15，求这个数。", "18"],
        ["某商品降价 8 元后为 42 元，求原价。", "50 元"]
      ],
      "综合挑战": [
        ["解方程：2(x + 3) - 3(x - 1) = 8。", "x = 1"],
        ["解方程：(x + 2) / 3 - 1 = 2。", "x = 7"],
        ["甲乙两人共有 54 元，甲的钱是乙的 2 倍少 6 元，求乙有多少元。", "20 元"],
        ["一个两位数，个位数字比十位数字大 3，两个数字和为 9，求这个两位数。", "36"],
        ["一根绳子剪去 1/3 后还剩 24 m，求原长。", "36 m"]
      ]
    },
    "七上：几何图形初步": {
      "中档提高": [
        ["已知∠AOB = 96°，OC 平分∠AOB，求∠AOC。", "48°"],
        ["一个角的余角比这个角小 20°，求这个角。", "55°"],
        ["线段 AB = 18 cm，点 C 在 AB 上，且 AC = 2BC，求 BC。", "6 cm"],
        ["若∠1 与∠2 互补，且∠1 = 3∠2，求∠2。", "45°"],
        ["钟面上 3 点 30 分时，时针和分针的夹角是多少？", "75°"]
      ],
      "综合挑战": [
        ["已知点 C 在线段 AB 上，AB = 24 cm，AC 比 BC 多 6 cm，求 AC。", "15 cm"],
        ["已知∠AOB = 120°，OC 平分∠AOB，OD 平分∠BOC，求∠COD。", "30°"],
        ["一个角的补角是它的 4 倍，求这个角。", "36°"],
        ["点 B、C 在线段 AD 上，AB = 5，BC = 2AB，CD = 3，求 AD。", "18"],
        ["若∠1 和∠2 互余，∠2 和∠3 互补，且∠1 = 40°，求∠3。", "130°"]
      ]
    },
    "七下：相交线与平行线": {
      "中档提高": [
        ["两直线相交，若一组邻补角的差为 40°，求较小角。", "70°"],
        ["已知 a ∥ b，同旁内角分别为 x° 和 3x°，求 x。", "45"],
        ["若两条直线被第三条直线所截，一组内错角相等，能得出什么结论？", "两直线平行"],
        ["已知 a ∥ b，一个同位角为 72°，求它的邻补角。", "108°"],
        ["一个角的对顶角是 58°，求它邻补角的度数。", "122°"]
      ],
      "综合挑战": [
        ["已知 a ∥ b，∠1 = 2x + 10°，∠2 = 3x - 20°，且∠1 与∠2 是内错角，求 x。", "x = 30"],
        ["两条平行线被截线所截，一组同旁内角差为 30°，求较小角。", "75°"],
        ["已知∠1 与∠2 互补，∠2 与∠3 是对顶角，若∠1 = 65°，求∠3。", "115°"],
        ["若 a ∥ b，∠1 = 120°，∠2 与∠1 是同旁内角，求∠2。", "60°"],
        ["判断：同位角相等一定能推出两直线平行吗？说明条件。", "在两条直线被第三条直线所截时，可以推出两直线平行"]
      ]
    },
    "七下：实数": {
      "中档提高": [
        ["若 √x = 6，求 x。", "36"],
        ["求 64 的平方根和算术平方根。", "平方根 ±8，算术平方根 8"],
        ["比较大小：√17 与 4。", "√17 > 4"],
        ["若 x^3 = -125，求 x。", "-5"],
        ["估算 √30 在哪两个相邻整数之间。", "5 和 6 之间"]
      ],
      "综合挑战": [
        ["若 a 是 25 的算术平方根，b 是 -8 的立方根，求 a + b。", "3"],
        ["已知 4 < √m < 5，写出一个整数 m。", "如 17 至 24 中任意一个"],
        ["若 |x - 3| + √(y - 4) = 0，求 x + y。", "7"],
        ["比较大小：√50 - 1 与 6。", "√50 - 1 > 6"],
        ["求满足 2 < √n < 3 的整数 n。", "5、6、7、8"]
      ]
    },
    "七下：平面直角坐标系": {
      "中档提高": [
        ["点 A(-2, 5) 向右平移 4 个单位，再向下平移 3 个单位，求新坐标。", "(2, 2)"],
        ["若点 P(a, -3) 在第四象限，a 应满足什么条件？", "a > 0"],
        ["点 M(3, b) 到 x 轴距离为 5，求 b。", "b = ±5"],
        ["已知点 A(1, 2)，B(1, -4)，求 AB 的长度。", "6"],
        ["点 C 在 y 轴上，且纵坐标为 -6，写出 C 的坐标。", "(0, -6)"]
      ],
      "综合挑战": [
        ["点 P(-3, 2) 先向右平移 5 个单位，再向下平移 6 个单位，求新坐标。", "(2, -4)"],
        ["已知 A(a - 2, 3) 在 y 轴上，求 a。", "a = 2"],
        ["已知点 P(m, m - 4) 在第四象限，求 m 的取值范围。", "0 < m < 4"],
        ["点 A(-2, 1)，B(4, 1)，求线段 AB 的长度。", "6"],
        ["一个长方形三个顶点为 (0,0)、(5,0)、(0,3)，求第四个顶点坐标。", "(5,3)"]
      ]
    },
    "七下：二元一次方程组": {
      "中档提高": [
        ["解方程组：2x + y = 9，x - y = 3。", "x = 4，y = 1"],
        ["解方程组：3x - y = 5，x + y = 7。", "x = 3，y = 4"],
        ["若 x + y = 6，2x - y = 3，求 x。", "x = 3"],
        ["甲乙两数和为 20，甲比乙的 2 倍少 1，求乙。", "乙 = 7"],
        ["买 2 支笔和 3 本本子共 13 元，1 支笔和 1 本本子共 5 元，求笔价。", "2 元"]
      ],
      "综合挑战": [
        ["解方程组：2x + 3y = 16，3x - y = 5。", "x = 31/11，y = 38/11"],
        ["若 2x + y = 10，x - 2y = -3，求 x + y。", "7"],
        ["鸡兔同笼共 10 只，腿共 28 条，求鸡兔各多少只。", "鸡 6 只，兔 4 只"],
        ["甲乙两种票共 20 张，甲票 8 元，乙票 5 元，总价 130 元，求甲票数。", "10 张"],
        ["已知 x:y = 2:3，且 x + y = 25，求 x。", "10"]
      ]
    },
    "七下：不等式与不等式组": {
      "中档提高": [
        ...
        ["解不等式：2(x - 1) < x + 3。", "x < 5"],
        ["解不等式：-2x + 6 ≥ 10。", "x ≤ -2"],
        ["求不等式组 x > -1，x < 3 的整数解。", "0、1、2"],
        ["某数的 2 倍加 1 不小于 9，求这个数的取值范围。", "x ≥ 4"]
      ],
      "综合挑战": [
        ["解不等式组：2x - 1 > 5，x + 3 ≤ 8。", "3 < x ≤ 5"],
        ["解不等式：3 - 2(x + 1) ≥ 7。", "x ≤ -3"],
        ["若 5x - 2 < 3x + 6，求 x 的最大整数解。", "3"],
        ["某商品单价 12 元，购买 x 件总价不超过 100 元，求 x 的最大整数值。", "8"],
        ["解不等式组：x - 2 ≥ 0，2x + 1 < 9。", "2 ≤ x < 4"]
      ]
    },
    "七下：数据的收集整理与描述": {
      "中档提高": [
        ["某班 50 人，喜欢足球的有 18 人，求喜欢足球的频率。", "0.36"],
        ["一次抽样中合格频率为 0.92，样本容量为 100，求合格件数。", "92"],
        ["扇形统计图中某类占 30%，对应人数为 15，求总人数。", "50"],
        ["频数分别为 6、9、15，求第三组频率。", "15/30 = 0.5"],
        ["样本容量为 80，某组频率为 0.25，求该组频数。", "20"]
      ],
      "综合挑战": [
        ["某调查中 A 类 12 人，占 24%，求样本容量和非 A 类人数。", "样本容量 50，非 A 类 38 人"],
        ["一组数据分三类，第一类频率 0.2，第二类频数 18，总数 60，求第三类频数。", "30"],
        ["抽查产品 200 件，不合格率 3%，求合格件数。", "194"],
        ["某班 40 人，喜欢篮球占 35%，喜欢足球占 25%，其余喜欢羽毛球，求喜欢羽毛球人数。", "16 人"],
        ["频数表中甲组 8 人，乙组比甲组多 50%，丙组为 10 人，求总人数。", "30 人"]
      ]
    }
  };

  const questions = overrides[chapter]?.[difficulty] || bank.questions;
...
function localWorksheet(payload, reason = "未配置 OPENROUTER_API_KEY") {
  ...
  const difficulty = payload.difficulty || "基础巩固";
  const bank = worksheetDifficultyBank(payload.chapter, difficulty);
  const questions = [];
  const answerKey = [];
...
6. 难度必须真正变化，不能只改变标题：
   - 基础巩固：直接套概念或一步计算。
   - 中档提高：需要一次变形、一次转化或两步计算。
   - 综合挑战：需要读题建模、分类讨论、综合两个知识点或两步以上推理。
7. 如果同一章节换了难度，题目内容、数字和考查方式都要明显不同。
`;
}
